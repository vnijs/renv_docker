#!/bin/bash
# script to start Rstudio server for research project
...
function launch_usage() {
  ...
  echo ""
  echo "Example: $0 --tag 1.5.0 --directory ~/project_1"
  echo ""
  exit 1
}
...
if [ "${has_docker}" == "" ]; then
  ...
  show_service () {
    ...
    echo "-----------------------------------------------------------------------"
    echo "Press (1) to show Rstudio, followed by [ENTER]:"
    echo "Press (2) to show a (bash) terminal, followed by [ENTER]:"
    echo "Press (3) to update the ${LABEL} container, followed by [ENTER]:"
    echo "Press (4) to clear Rstudio sessions and packages, followed by [ENTER]:"
    echo "Press (q) to stop the docker process, followed by [ENTER]:"
    echo "-----------------------------------------------------------------------"
    echo "Note: To start, e.g., Rstudio on a different port type 1 8788 [ENTER]"
